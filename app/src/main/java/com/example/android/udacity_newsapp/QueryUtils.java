...
public class QueryUtils {
    ...
    public static List<Model> fetchEarthquakeData(String requestUrl) {
        ...
        List<Model> earthquakes = extractFeatureFromJson(jsonResponse);
    ...
    private static List<Model> extractFeatureFromJson(String guardianJSON) {
        ...
        try {
            ...
            Log.i("ModelArray", resultArray.toString());
